  ...
  <body>
                ...
                <ul id="nav">
                  ...
                  <li>
                    ...
                    <ul class="dropdown">
                      ...
                      <li><a href="speakers.php">- Speakears</a></li>
    ...
    <section class="welcome-area">
      <div class="welcome-slides owl-carousel">
        <div
          class="single-welcome-slide bg-img bg-overlay jarallax"
        ...
        <div
          class="single-welcome-slide bg-img bg-overlay jarallax"
          style="background-image: url(img/bg-img/45.jpg)"
        >
          <div class="container h-100">
            <div class="row h-100 align-items-center">
              <div class="col-12">
                <div class="welcome-text-two text-center">
                  ...
                  <div
                    ...
                    data-delay="500ms"
                  >
                    <a class="event-date" href="#"
                      ><i class="zmdi zmdi-account"></i> January 14, 2019</a
                    >
                    <a class="event-author" href="#"
                      ><i class="zmdi zmdi-alarm-check"></i> Laura Green</a
                    >
                  </div>
                  <div
                    class="hero-btn-group"
                    ...
                    data-delay="700ms"
                  >
                    <a href="#" class="btn confer-btn m-2"
        ...
        <div class="row align-items-center">
          <div class="col-12 col-md-6">
            <div class="about-content-text mb-80">
              <h6 class="wow fadeInUp" data-wow-delay="300ms">
                About Conference
              </h6>
              ...
              <a
                href="#"
                class="btn confer-btn mt-50 wow fadeInUp"
                data-wow-delay="300ms"
                >Interested <i class="zmdi zmdi-long-arrow-right"></i
              ></a>
            </div>
          </div>
        ...
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-12 col-md-9">
              <div
                class="countdown-timer mb-100 wow fadeInUp"
                data-wow-delay="300ms"
              >
                <div id="clock"></div>
              </div>
    ...
    <section
      class="our-speaker-area bg-img bg-gradient-overlay section-padding-100-60"
        ...
        <div class="row">
          ...
          <div class="col-12">
            <div
              ...
              data-wow-delay="300ms"
            >
              <a class="btn confer-btn-white" href="#"
                  ...
                  <div class="row">
                    ...
                    <div class="col-12">
                      <div
                        ...
                        data-wow-delay="300ms"
                      >
                        <a href="#" class="btn confer-gb-btn"
                          >Dowload schedule (Pdf)</a
                        >
                      </div>
                    </div>
                  </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-12 col-lg-4">
            <div
              class="single-ticket-pricing-table text-center mb-100 wow fadeInUp"
              data-wow-delay="300ms"
            >
              ...
              <a href="#" class="btn confer-btn w-100 mb-30"
                >Get Tickets <i class="zmdi zmdi-long-arrow-right"></i
              ></a>
              ...
              <div class="ticket-pricing-table-details">
                ...
                <p>
                  <i class="zmdi zmdi-check"></i> Talk to the Editors Session
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="col-12 col-md-6 col-lg-4">
            <div
              class="single-ticket-pricing-table active text-center mb-100 wow fadeInUp"
              data-wow-delay="300ms"
            >
    ...
    <section class="our-sponsor-client-area section-padding-100">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-12">
            <div
              class="our-client-area mt-100 wow fadeInUp"
              data-wow-delay="300ms"
            >
    ...
    <section
      class="our-blog-area bg-img bg-gradient-overlay section-padding-100-60"
          ...
          <div class="col-12 col-md-6 col-lg-4">
            <div class="single-blog-area wow fadeInUp" data-wow-delay="300ms">
              ...
              <div class="single-blog-text text-center">
                ...
                <p>
                  Street Food Convention will showcase products like Packed
                  food, beef and lamb, street food.
                </p>
              </div>
              <div class="blog-btn">
        ...
        <div class="row justify-content-between">
          <div class="col-12 col-sm-3">
            <div class="contact-information mb-100">
              <div
                class="single-contact-info wow fadeInUp"
                data-wow-delay="300ms"
              >
                <p>Address:</p>
              ...
              >
                ...
                <h6>
                  <a
                    ...
                    class="__cf_email__"
                    data-cfemail="2e4d4140484b5c6e49434f4742004d4143"
                    >[email&#160;protected]</a
                  >
                </h6>
              </div>
          ...
          <div class="col-12 col-sm-8">
            <div
              class="contact_from_area mb-100 clearfix wow fadeInUp"
              data-wow-delay="300ms"
            >
              <div class="contact_form">
                <form action="userinfo.php" method="post" id="main_contact_form">
                ...
                <div class="footer-contact-info">
                  ...
                  <p>
                    ...
                    <a
                      href="/cdn-cgi/l/email-protection"
                      class="__cf_email__"
                      data-cfemail="2f4c4041494a5d6f48424e4643014c4042"
                      >[email&#160;protected]</a
                    >
                  </p>
            ...
            <div class="col-12 col-md-6">
              <div class="footer-menu">
                <ul class="nav">
                  <li>
                    <a href="#"
                      ><i class="zmdi zmdi-circle"></i> Terms of Service</a
                    >
                  </li>
                  <li>
                    <a href="#"
                      ><i class="zmdi zmdi-circle"></i> Privacy Policy</a
                    >
                  </li>
                </ul>
              </div>
    ...
    <script
      ...
      data-cf-beacon='{"rayId":"7e9158acbf9e89e1","version":"2023.4.0","b":1,"token":"cd0b4b3a733644fc843ef0b185f98241","si":100}'
